...
**Note**: This requires properly configured Azure resources (Cosmos DB, AI Search, Azure OpenAI).
...
4. Azure OpenAI gpt-5.2 model deployed
...
3. **OpenAI API Errors**
   - Check: gpt-5.2 deployment exists
